...
main(int argc, char *argv[])
{
  ...
  34:	8d0a8a93          	addi	s5,s5,-1840 # 900 <malloc+0xfa>
  ...
  6a:	8a258593          	addi	a1,a1,-1886 # 908 <malloc+0x102>
  6e:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	50250513          	addi	a0,a0,1282 # 918 <digits>
 41e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6b0:	26cb8b93          	addi	s7,s7,620 # 918 <digits>
 ...
 6fe:	21690913          	addi	s2,s2,534 # 910 <malloc+0x10a>
        for(; *s; s++)
